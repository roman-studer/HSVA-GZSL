...
class encoder_z_v5(nn.Module):
    ...
    def __init__(self, input_dim, latent_size, device):
        ...
        self.layer_sizes = [input_dim, 64, latent_size]
        modules = []
...
class encoder_template_v5(nn.Module):
    ...
    def __init__(self, input_dim, output_dim, device):
        ...
        self.feature_encoder = nn.Sequential(nn.Linear(input_dim, 4096), nn.LeakyReLU(0.2, True),
...
class decoder_template(nn.Module):
    ...
    def __init__(self, input_dim, output_dim, device):
        ...
        self.layer_sizes = [input_dim, 64, output_dim]
        self.feature_decoder = nn.Sequential(nn.Linear(input_dim, self.layer_sizes[1]), nn.LeakyReLU(0.2, True),
...
class decoder_z(nn.Module):
    ...
    def __init__(self, latent_size, output_dim, device):
        ...
        self.feature_decoder = nn.Sequential(nn.Linear(latent_size, self.layer_sizes[1]), nn.LeakyReLU(0.2, True),
                                             nn.Linear(self.layer_sizes[1], output_dim))
...
class domain_classifier(nn.Module):
    def __init__(self, hidden_size, device):
        ...
        self.classify = nn.Sequential(nn.Linear(hidden_size, 512), nn.LeakyReLU(0.2, True), nn.Linear(512, 1),
                                      nn.Sigmoid())
        self.to(device)
...
class domain_discriminator(nn.Module):
    def __init__(self, input_dim, output_dim, hiden_size, device):
        ...
        self.discriminator = nn.Sequential(nn.Linear(input_dim, output_dim), nn.LeakyReLU(0.2, True),
