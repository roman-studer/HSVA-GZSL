...
parser.add_argument('--cls_train_steps', type=int, default=20)
...
parser.add_argument('--cross_reconstruction_factor_end_epoch', type=int, default=75,
                    help='cross reconstruction factor end epoch')
...
parser.add_argument('--split', type=int, default=1, help='data split to use')
parser.add_argument('--gen_warmup', type=int, default=35, help='generator warmup')
